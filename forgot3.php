...
mysqli_query($conn," UPDATE users SET password='$password' WHERE id_user='$_SESSION[id_user]' ");
...
?>
		 ...
		 <div class="form-group">
	    	...
	    	<input type="password" class="form-control unicase-form-control text-input" id="password" name="password"  required  placeholder="enter password">
	  	</div>
